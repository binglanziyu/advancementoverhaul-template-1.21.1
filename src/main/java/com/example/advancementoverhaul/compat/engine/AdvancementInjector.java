...
public final class AdvancementInjector {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger("AdvancementOverhaul/Injector");
    ...
    public static AdvancementHolder parseHolder(RegistryOps<JsonElement> ops,
        ...
        boolean isVanilla = !com.example.advancementoverhaul.ModInfo.MOD_ID.equals(id.getNamespace());
        if (isVanilla) {
