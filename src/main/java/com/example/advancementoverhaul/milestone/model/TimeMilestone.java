...
public record TimeMilestone(String id, String nameKey, String descriptionKey, String iconItem, String category, int unlockDay, long unlockTick, boolean unlocked, String linkedAdvancement, boolean autoAdvancement, String requiredAdvancement, String source, String customName, String customDesc, String customTrigger, String customParam, long customThreshold) {
    ...
    public static TimeMilestone fromJson(JsonObject obj) {
        return new TimeMilestone(TimeMilestone.str(obj, "id", ""), TimeMilestone.str(obj, "nameKey", ""), TimeMilestone.str(obj, "descriptionKey", ""), TimeMilestone.str(obj, "iconItem", "minecraft:paper"), TimeMilestone.str(obj, "category", "journey"), obj.has("unlockDay") ? obj.get("unlockDay").getAsInt() : 0, obj.has("unlockTick") ? obj.get("unlockTick").getAsLong() : 0L, obj.has("unlocked") && obj.get("unlocked").getAsBoolean(), TimeMilestone.strOrNull(obj, "linkedAdvancement"), obj.has("autoAdvancement") && obj.get("autoAdvancement").getAsBoolean(), TimeMilestone.strOrNull(obj, "requiredAdvancement"), TimeMilestone.str(obj, "source", "config"), TimeMilestone.strOrNull(obj, "customName"), TimeMilestone.strOrNull(obj, "customDesc"), TimeMilestone.strOrNull(obj, "customTrigger"), TimeMilestone.strOrNull(obj, "customParam"), obj.has("customThreshold") ? obj.get("customThreshold").getAsLong() : 1L);
    }
