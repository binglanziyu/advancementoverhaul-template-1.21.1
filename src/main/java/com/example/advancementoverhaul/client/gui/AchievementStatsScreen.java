...
public class AchievementStatsScreen extends Screen {
    ...
    // ── Color palette (parchment theme, distinct from main Theme.java) ──
    private static final int COLOR_BG            = 0xFF0F0E09;
    private static final int COLOR_OVERLAY_TOP   = 0x60F0F0F6;
    private static final int COLOR_PANEL         = 0xFFE9E0D9;
    private static final int COLOR_PANEL_BORDER  = 0x40A0A0A0;
    private static final int COLOR_DIVIDER       = 0xFFC8B8A0;
    private static final int COLOR_TEXT_PRIMARY  = 0xFF4B5A28;
    private static final int COLOR_TEXT_SECONDARY= 0xFF806E50;
    private static final int COLOR_TEXT_EMPHASIS = 0xFF3A4A18;
    private static final int COLOR_TEXT_WHITE    = 0xFFF0F0F0;
    private static final int COLOR_ACCENT_GREEN  = 0xFF7BBD48;
    private static final int COLOR_ACCENT_GLOW   = 0x407BBD48;
    private static final int COLOR_PROGRESS_BG   = 0xFFC8B8A0;
    private static final int COLOR_SIDEBAR_BG    = 0xFFD8C8B0;
    private static final int COLOR_SIDEBAR_HOV   = 0xFFE8D8C0;
    private static final int COLOR_CARD_BG       = 0xFFF0E8D8;
    private static final int COLOR_CARD_HOV      = 0xFFE8D8C0;
    private static final int COLOR_CLOSE_BG      = 0x30A08060;
    private static final int COLOR_CLOSE_HOV     = 0x60A08060;
    private static final int COLOR_SCROLL_TRACK  = 0x20A09080;
    private static final int COLOR_SCROLL_THUMB  = 0xFFC8B8A0;
    private static final int COLOR_UNAVAILABLE   = 0xFFC0B8A8;
