...
public class Config {
    ...
    /** 是否用 TimelineScreen 替换原版统计界面（StatsScreen） */
    public static final ModConfigSpec.BooleanValue REPLACE_STATS_SCREEN;
    ...
    static {
        ...
        REPLACE_STATS_SCREEN = b
                .comment("Replace vanilla stats screen (Statistics) with timeline screen")
                .define("replaceStatsScreen", true);
        b.pop();
