...
import static com.dreamer.ao.client.gui.Theme.CARD_H;
import static com.dreamer.ao.client.gui.Theme.CARD_W;
...
final class VanillaLayoutEngine {
    ...
    void recalcVanillaPositions() {
        if (!screen.screenState.isDirty(ScreenState.DIRTY_VANILLA_POS)) return;
