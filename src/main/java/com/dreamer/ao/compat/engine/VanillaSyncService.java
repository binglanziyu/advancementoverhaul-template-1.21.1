...
public final class VanillaSyncService {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(VanillaSyncService.class);
    ...
    public static void updateAdvancementInRuntime(MinecraftServer server, String customId) {
        Map<ResourceLocation, AdvancementHolder> map = AdvancementMapHolder.getMutableMap();
        if (map == null) {
